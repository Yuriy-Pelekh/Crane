  ...
  public class ControllerHelper
  {
    ...
    public Controller CreateController()
    {
      ...
      foreach (var variable in Inputs)
      {
        ...
        {
          throw new AlgorithmException("Input variable \"" + variable.Name + "\" should contain at least 2 terms.");
        }
      ...
      foreach (var item in Inputs.Select(variable => new Variable(variable.Name) {Terms = variable.Terms, NumericInput = variable.NumericInput}))
      {
